 ...
 */
#define AP_DESIGNER_FREESCALE    0x00e  /* ARM Ltd. */
#define AP_DESIGNER_TEXAS        0x017  /* Freescale */
#define AP_DESIGNER_ATMEL        0x01f  /* Texas Instruments */
#define AP_DESIGNER_STM          0x020  /* Atmel (Microchip) */
#define AP_DESIGNER_CYPRESS      0x034  /* STMicroelectronics */
...
#define AP_MANUFACTURER_RENESAS  0x423  /* Renesas */
