...
const struct command_s lpc546xx_cmd_list[] = {
    ...
    { "partid", lpc546xx_cmd_part_id, "Return the 32-bit part-id (aka device-id or chip-id)." },
    { "readuid", lpc546xx_cmd_read_uid, "Read out the 16-byte UID." },
...
bool lpc546xx_probe(target *t)
{
    ...
    switch(chipid) {
    case 0x7F954605:  /* LPC54605J256 - M4 256K Flash 128K SRAM - UM10912 Rev 2.4 2019 Ch 7.5.99 Table 232 */
    case 0xFFF54605:  /* LPC54605J512 - M4 512K Flash 192K SRAM - UM10912 Rev 2.4 2019 Ch 7.5.99 Table 232 */
    case 0x7F954606:  /* LPC54606J256 - M4 256K Flash 128K SRAM - UM10912 Rev 2.4 2019 Ch 7.5.99 Table 232 */
    case 0xFFF54606:  /* LPC54606J512 - M4 512K Flash 192K SRAM - UM10912 Rev 2.4 2019 Ch 7.5.99 Table 232 */
    case 0x7F954607:  /* LPC54607J256 - M4 256K Flash 128K SRAM - UM10912 Rev 2.4 2019 Ch 7.5.99 Table 232 */
    case 0xFFF54607:  /* LPC54607J512 - M4 512K Flash 192K SRAM - UM10912 Rev 2.4 2019 Ch 7.5.99 Table 232 */
    case 0xFFF54608:  /* LPC54608J512 - M4 512K Flash 192K SRAM - UM10912 Rev 2.4 2019 Ch 7.5.99 Table 232 */
    case 0x7F954616:  /* LPC54616J256 - M4 256K Flash 128K SRAM - UM10912 Rev 2.4 2019 Ch 7.5.99 Table 232 */
    case 0xFFF54616:  /* LPC54616J512 - M4 512K Flash 192K SRAM - UM10912 Rev 2.4 2019 Ch 7.5.99 Table 232 */
    case 0xFFF54618:  /* LPC54618J512 - M4 512K Flash 192K SRAM - UM10912 Rev 2.4 2019 Ch 7.5.99 Table 232 */
    case 0xFFF54628:  /* LPC54628J512 - M4 512K Flash 192K SRAM - UM10912 Rev 2.4 2019 Ch 7.5.99 Table 232 */
        t->driver = "LPC546xx";
        lpc546xx_add_flash(t, IAP_ENTRYPOINT_LOCATION, 0, 0x0, lpc_flash_size(chipid, 0x80000), 0x8000);

        /* Note: upper 96 KiB is only usable after enabling the appropriate control
           register bits, see LPC546xx User Manual: 7.5.19 AHB Clock Control register 0
        */
        target_add_ram(t, 0x20000000, 0x28000);
        target_add_commands(t, lpc546xx_cmd_list, t->driver);
